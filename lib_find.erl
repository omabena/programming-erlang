...
find_files([File | T], Dir, Reg, Recursive, Fun,
           Acc0) ->
    ...
    case file_type(FullName) of
        regular ->
            case re:run(FullName, Reg, [{capture, none}]) of
                ...
                nomatch -> find_files(T, Dir, Reg, Recursive, Fun, Acc0)
            end;
        directory ->
            case Recursive of
                true ->
                ...
                false -> find_files(T, Dir, Reg, Recursive, Fun, Acc0)
            end;
        error -> find_files(T, Dir, Reg, Recursive, Fun, Acc0)
    end;
